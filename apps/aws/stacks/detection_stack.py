...
class DetectionStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # Lambda from Docker image (built from apps/aws/lambda/detect)
        ...
        # Optional: create a cost budget in AWS Console (Billing → Budgets).
        # CDK cannot declare budget *notifications* without at least one email/SNS subscriber.
