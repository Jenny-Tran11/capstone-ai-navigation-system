    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-sm mb-10" style={{ color: 'var(--warm-muted)' }}>
          University of Wollongong · School of Computing and Information
          Technology · Capstone 2026
        </p>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          <p
            ...
            style={{ color: 'var(--warm-fg)' }}
          >
            "Every design decision in AI-Detect prioritises users who cannot
            rely on visual feedback. The interface defaults to audio-first,
            touch-first, and network-resilient operation."
          </p>
        </blockquote>
      </div>
    </section>
