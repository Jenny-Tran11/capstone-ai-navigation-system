      ...
      <div className="max-w-2xl mx-auto px-6 py-24 space-y-12">
        ...
        {status === 'success' ? (
          ...
          >
            ...
            <h2 className="text-2xl font-light" style={{ color: 'var(--warm-fg)' }}>
              Message sent
            </h2>
            <p className="text-sm" style={{ color: 'var(--warm-muted)' }}>
              Thanks for reaching out. We'll get back to you at your email address as soon as
              possible.
            </p>
            <button
              ...
              onMouseEnter={(e) =>
                ((e.currentTarget as HTMLElement).style.color = 'var(--warm-primary-hover)')
              }
              onMouseLeave={(e) =>
